...
| `management` | STRING | `Govt.`, `Trust`, `Society`, `Private`, `Govt- Society`, … |
...
| Management | Colleges | Seats |
|---|---:|---:|
| Govt-managed (`management` starts with `Govt`) | 430 | 60,324 |
| Other (Trust / Society / Private) | 350 | 57,866 |
